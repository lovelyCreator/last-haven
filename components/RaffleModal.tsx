...
export default function RaffleModal({
  ...
  const sendRazeToken = async () => {
    setBuyLoad(true);
    const data = await axios.post("https://last-haven-server-gwv5.onrender.com/api/buyTicketInfo/getInvaild")
  ...
  const getCurrentTokens = async () => {
    const response = await axios.post("https://last-haven-server-gwv5.onrender.com/api/buyTicketInfo/getTokens", { address: publicKey?.toBase58() })
  ...
  const sendTransactionResult = async () => {
    ...
    const response = await axios.post("https://last-haven-server-gwv5.onrender.com/api/buyTicketInfo/create", data)
    setCurrentTokens(response.data.total)
    toast.success("Success")
    setConfirm(false)
  }
  const getEndedTime = async () => {
    const response = await axios.post("https://last-haven-server-gwv5.onrender.com/api/ticket/getTicketInfo");
  ...
  const getTickets = async () => {
    const response = await axios.post("https://last-haven-server-gwv5.onrender.com/api/buyTicketInfo/purchasedTickets");
