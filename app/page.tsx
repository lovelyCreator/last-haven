...
export default function Home() {
  ...
  const socket = io('https://last-haven-server-gwv5.onrender.com/');
  ...
  const handleChatClick = async () => {
    ...
    try {
      const response = await axios.post('https://last-haven-server-gwv5.onrender.com/api/chat/wallet', { walletAddress: publicKey?.toBase58() });
